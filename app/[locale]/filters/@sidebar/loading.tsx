                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-2">
                                <Skeleton className="h-8 w-16 rounded-md" /> {/* Tag */}
                                <Skeleton className="h-8 w-20 rounded-md" /> {/* Tag */}
                                <Skeleton className="h-8 w-14 rounded-md" /> {/* Tag */}
                                <Skeleton className="h-8 w-18 rounded-md" /> {/* Tag */}
                            </div>
                        </div>
                    </div>
                </div>
